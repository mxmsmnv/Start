...
HTML;
  ...
  const TRANSLATIONS = [
    ...
    'tr' => [
      'start'           => 'Başlat',
      'edit_links'      => 'Bağlantıları düzenle',
      'edit_links_title'=> 'Başlat — Bağlantıları düzenle',
      'view_mode'       => 'Görünüm',
      'list_view'       => 'Liste görünümü',
      'icon_view'       => 'Simge görünümü',
      'view_all'        => 'Tümünü göster',
      'no_links'        => 'Bağlantı yok. Lütfen %sbağlantıları yapılandırın%s.',
      'links_saved'     => 'Bağlantılar kaydedildi.',
      'back'            => 'Geri',
      'example'         => 'Örnek',
      'clear_all'       => 'Tümünü temizle',
      'save'            => 'Kaydet',
      'language_label'  => 'Arayüz dili',
      'language_desc'   => 'Start panosu için kullanılan dil.',
      'add_link'        => '+ Bağlantı ekle',
      'add_group'       => 'Grup ekle',
      'remove'          => 'Kaldır',
      'remove_group'    => 'Grubu kaldır',
      'browse_page'     => 'Sayfalara göz at',
      'select_page'     => 'Sayfa seçin',
      'select_icon'     => 'Simge seçin',
      'columns'         => 'Sütunlar',
      'search_pages'    => 'Sayfa ara…',
      'loading'         => 'Yükleniyor…',
    ],
    'cs' => [
      'start'           => 'Start',
      'edit_links'      => 'Upravit odkazy',
      'edit_links_title'=> 'Start — Upravit odkazy',
      'view_mode'       => 'Zobrazení',
      'list_view'       => 'Zobrazení seznamu',
      'icon_view'       => 'Zobrazení ikon',
      'view_all'        => 'Zobrazit vše',
      'no_links'        => 'Žádné odkazy. Prosím %skonfigurujte odkazy%s.',
      'links_saved'     => 'Odkazy uloženy.',
      'back'            => 'Zpět',
      'example'         => 'Příklad',
      'clear_all'       => 'Vymazat vše',
      'save'            => 'Uložit',
      'language_label'  => 'Jazyk administrace',
      'language_desc'   => 'Jazyk rozhraní panelu Start.',
      'add_link'        => '+ Přidat odkaz',
      'add_group'       => 'Přidat skupinu',
      'remove'          => 'Odstranit',
      'remove_group'    => 'Odstranit skupinu',
      'browse_page'     => 'Procházet stránky',
    ...
    'fi' => [
      'start'           => 'Aloitus',
      'edit_links'      => 'Muokkaa linkkejä',
      'edit_links_title'=> 'Aloitus — Muokkaa linkkejä',
      'view_mode'       => 'Näkymä',
      'list_view'       => 'Listanäkymä',
      'icon_view'       => 'Kuvakenäkymä',
      'view_all'        => 'Näytä kaikki',
      'no_links'        => 'Ei linkkejä. Ole hyvä ja %smäärittele linkit%s.',
      'links_saved'     => 'Linkit tallennettu.',
      'back'            => 'Takaisin',
      'example'         => 'Esimerkki',
      'clear_all'       => 'Tyhjennä kaikki',
      'save'            => 'Tallenna',
      'language_label'  => 'Hallintakieli',
      'language_desc'   => 'Start-paneelin käyttöliittymän kieli.',
      'add_link'        => '+ Lisää linkki',
      'add_group'       => 'Lisää ryhmä',
      'remove'          => 'Poista',
      'remove_group'    => 'Poista ryhmä',
      'browse_page'     => 'Selaa sivuja',
      'select_page'     => 'Valitse sivu',
      'select_icon'     => 'Valitse kuvake',
      'columns'         => 'Sarakkeet',
      'search_pages'    => 'Etsi sivuja…',
      'loading'         => 'Ladataan…',
    ],
    'ko' => [
      'start'           => '시작',
      'edit_links'      => '링크 편집',
      'edit_links_title'=> '시작 — 링크 편집',
      'view_mode'       => '보기',
      'list_view'       => '목록 보기',
      'icon_view'       => '아이콘 보기',
      'view_all'        => '모두 보기',
      'no_links'        => '링크가 없습니다. %s링크를 설정%s해 주세요.',
      'links_saved'     => '링크가 저장되었습니다.',
      'back'            => '뒤로',
      'example'         => '예시',
      'clear_all'       => '모두 지우기',
      'save'            => '저장',
      'language_label'  => '관리 언어',
      'language_desc'   => 'Start 대시보드 인터페이스 언어.',
      'add_link'        => '+ 링크 추가',
      'add_group'       => '그룹 추가',
      'remove'          => '삭제',
      'remove_group'    => '그룹 삭제',
    ...
    'hi' => [
      'start'           => 'स्टार्ट',
      'edit_links'      => 'लिंक संपादित करें',
      'edit_links_title'=> 'स्टार्ट — लिंक संपादित करें',
      'view_mode'       => 'दृश्य',
      'list_view'       => 'सूची दृश्य',
      'icon_view'       => 'आइकन दृश्य',
      'view_all'        => 'सभी देखें',
      'no_links'        => 'कोई लिंक नहीं। कृपया %sलिंक कॉन्फ़िगर करें%s।',
      'links_saved'     => 'लिंक सहेजे गए।',
      'back'            => 'वापस',
      'example'         => 'उदाहरण',
      'clear_all'       => 'सब हटाएं',
      'save'            => 'सहेजें',
      'language_label'  => 'व्यवस्थापक भाषा',
      'language_desc'   => 'Start डैशबोर्ड के लिए उपयोग की जाने वाली भाषा।',
      'add_link'        => '+ लिंक जोड़ें',
      'add_group'       => 'समूह जोड़ें',
      'remove'          => 'हटाएं',
      'remove_group'    => 'समूह हटाएं',
      'browse_page'     => 'पृष्ठ देखें',
    ...
    'he' => [
      ...
      'edit_links_title'=> 'התחלה — ערוך קישורים',
      'view_mode'       => 'תצוגה',
      'list_view'       => 'תצוגת רשימה',
      'icon_view'       => 'תצוגת סמלים',
      'view_all'        => 'הצג הכל',
      'no_links'        => 'אין קישורים. אנא %sהגדר קישורים%s.',
      'links_saved'     => 'הקישורים נשמרו.',
      'back'            => 'חזרה',
      'example'         => 'דוגמה',
      'clear_all'       => 'נקה הכל',
      'save'            => 'שמור',
      'language_label'  => 'שפת ממשק',
      'language_desc'   => 'שפה המשמשת לממשק לוח המחוונים של Start.',
      'add_link'        => '+ הוסף קישור',
      'add_group'       => 'הוסף קבוצה',
      'remove'          => 'הסר',
      'remove_group'    => 'הסר קבוצה',
      'browse_page'     => 'עיין בדפים',
      'select_page'     => 'בחר דף',
      'select_icon'     => 'בחר סמל',
      'columns'         => 'עמודות',
      'search_pages'    => 'חפש דפים…',
      'loading'         => 'טוען…',
      'rtl'             => true,
    ],
    'ar' => [
      ...
      'edit_links_title'=> 'البداية — تعديل الروابط',
      'view_mode'       => 'عرض',
      'list_view'       => 'عرض القائمة',
      'icon_view'       => 'عرض الأيقونات',
      'view_all'        => 'عرض الكل',
      'no_links'        => 'لا توجد روابط. الرجاء %sتكوين الروابط%s.',
      'links_saved'     => 'تم حفظ الروابط.',
      'back'            => 'رجوع',
      'example'         => 'مثال',
      'clear_all'       => 'مسح الكل',
      'save'            => 'حفظ',
      'language_label'  => 'لغة الواجهة',
      'language_desc'   => 'اللغة المستخدمة لواجهة لوحة تحكم Start.',
      'add_link'        => '+ إضافة رابط',
      'add_group'       => 'إضافة مجموعة',
      'remove'          => 'إزالة',
      'remove_group'    => 'إزالة المجموعة',
      'browse_page'     => 'تصفح الصفحات',
    ...
    'hu' => [
      'start'           => 'Start',
      'edit_links'      => 'Hivatkozások szerkesztése',
      'edit_links_title'=> 'Start — Hivatkozások szerkesztése',
      'view_mode'       => 'Nézet',
      'list_view'       => 'Lista nézet',
      'icon_view'       => 'Ikon nézet',
      'view_all'        => 'Összes megjelenítése',
      'no_links'        => 'Nincs hivatkozás. Kérjük, %skonfigurálja a hivatkozásokat%s.',
      'links_saved'     => 'Hivatkozások mentve.',
      'back'            => 'Vissza',
      'example'         => 'Példa',
      'clear_all'       => 'Összes törlése',
      'save'            => 'Mentés',
      'language_label'  => 'Felület nyelve',
      'language_desc'   => 'A Start irányítópult felületének nyelve.',
      'add_link'        => '+ Hivatkozás hozzáadása',
      'add_group'       => 'Csoport hozzáadása',
      'remove'          => 'Eltávolítás',
      'remove_group'    => 'Csoport eltávolítása',
      'browse_page'     => 'Oldalak böngészése',
      'select_page'     => 'Oldal kiválasztása',
      'select_icon'     => 'Ikon kiválasztása',
      'columns'         => 'Oszlopok',
  ...
  public function getModuleConfigInputfields(array $data): InputfieldWrapper {
    ...
    $options = [
      ...
      'tr' => 'Türkçe',     'cs' => 'Čeština',    'fi' => 'Suomi',
      'ko' => '한국어',       'hi' => 'हिन्दी',       'he' => 'עברית',
      'ar' => 'العربية',    'hu' => 'Magyar',
    ];
  ...
  protected static function buildEditorHTML(string $json, int $cols, string $pickerUrl = ''): string {
    ...
    $isRtl        = !empty(self::TRANSLATIONS[$lang]['rtl']);
...
/* RTL support */
#st-editor[dir="rtl"] .st-grp-hdr,
#st-editor[dir="rtl"] .st-row{flex-direction:row-reverse}
#st-editor[dir="rtl"] .st-children{padding-left:0;padding-right:16px;border-left:none;border-right:2px solid var(--pw-border-color);margin-left:0;margin-right:18px}
#st-editor[dir="rtl"] .st-add-btn,
#st-editor[dir="rtl"] .st-editor-toolbar{direction:rtl}
#st-editor[dir="rtl"] #st-icon-count{text-align:left}
</style>

<div id="st-editor" data-json="{$jsonAttr}" data-picker-url="{$pickerUrl}" data-admin-url="{$adminUrlAttr}"{$dirAttr}>
